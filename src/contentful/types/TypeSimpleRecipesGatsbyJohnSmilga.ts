...
export type TypeSimpleRecipesGatsbyJohnSmilga<Modifiers extends ChainModifiers, Locales extends LocaleCode = LocaleCode> = Entry<TypeSimpleRecipesGatsbyJohnSmilgaSkeleton, Modifiers, Locales>;
