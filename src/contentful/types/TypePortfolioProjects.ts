...
export type TypePortfolioProjectsSkeleton = EntrySkeletonType<TypePortfolioProjectsFields, "portfolioProjects">;
export type TypePortfolioProjects<Modifiers extends ChainModifiers, Locales extends LocaleCode = LocaleCode> = Entry<TypePortfolioProjectsSkeleton, Modifiers, Locales>;
