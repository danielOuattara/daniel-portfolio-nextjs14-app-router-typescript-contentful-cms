...
export type TypePortfolioCertificates<Modifiers extends ChainModifiers, Locales extends LocaleCode = LocaleCode> = Entry<TypePortfolioCertificatesSkeleton, Modifiers, Locales>;
